    ...
    return (
        <div>
            ...
            <div className="d-flex col-10 mx-auto justify-content-around">
                <div onClick={() => handleClickOnSignUpAsBtn('signUpAsStudent')} style={{cursor: 'pointer'}} className="d-flex flex-column align-items-center"> 
                ...
                <div onClick={() => handleClickOnSignUpAsBtn('signUpAsTeacher')} style={{cursor: 'pointer'}} className="d-flex flex-column align-items-center"> 
