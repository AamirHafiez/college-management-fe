    ...
    return (
        <div>
            ...
            <div className="d-flex col-10 mx-auto justify-content-around">
                <div onClick={() => handleClickOnLoginAsBtn('loginAsStudent')} style={{cursor: 'pointer'}} className="d-flex flex-column align-items-center"> 
                ...
                <div onClick={() => handleClickOnLoginAsBtn('loginAsTeacher')} style={{cursor: 'pointer'}} className="d-flex flex-column align-items-center"> 
